...
def bot_ui():
    ...
    with tf.Session() as sess:
        ...
        print("Welcome to Chat with CyberKnows!")
        print("Type exit and press enter to end the conversation.")
        # Waiting from standard input.
        sys.stdout.write("Please Enter Line Here: ")
        sys.stdout.flush()
        question = sys.stdin.readline()
        while question:
            if question.strip() == 'exit':
                print ("Please rate this experience.")
                print("Thank you for using SyberKnows. Goodbye.")
                break
