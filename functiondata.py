...
class FunctionData:
    ...
    def get_NBA_any(self):
        self.chat_session.last_topic = "NBA"
        self.chat_session.keep_topic = True

        NBA = self.knowledge_base.NBA
        content = random.choice(NBA)
        return content
    ...
    def continue_last_topic(self):
        ...
        elif self.chat_session.last_topic == "NBA":
            self.chat_session.keep_topic = True
            return self.get_NBA_any()
        else:
...
def call_function(func_info, knowledge_base=None, chat_session=None, para_list=None):
    ...
    func_dict = {
        ...
        'get_NBA_any': func_data.get_NBA_any,
