...
class BotPredictor(object):
    ...
    def predict(self, session_id, question):
        ...
        if question.strip() == '':
            answer = "Don't you want to say something to me? You can ask for jokes, stories, and NBA news."
    ...
    def _get_final_output(self, sentence, chat_session, para_list=None):
        ...
        if sentence == '':
            return "I don't know what to say. You can ask for jokes, stories and NBA news.", False
